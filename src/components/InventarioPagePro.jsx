...
export default function InventarioPagePro() {
    ...
    const fetchMetrics = async () => {
        try {
            ...
            // Alertas críticas (agotados + bajo mínimo)
    ...
    const fetchProductos = async () => {
        try {
            ...
            // Usar la vista que calcula estados
            ...
            if (error) {
                // Si la vista no existe, usar tabla base
                ...
                if (baseError) {
                    console.error('Error fetching productos:', baseError);
                    return;
                }

                // Calcular estados manualmente
                                ...
                                <div className="refaccion-card-content">
                                    ...
                                    <div className="refaccion-detail">
                                        ...
                                        <span className="detail-value highlight">
                                            {producto.stock_disponible || producto.stock_actual || 0}
                                        </span>
                                    </div>
                                    ...
                                    <div className="refaccion-detail">
                                        ...
                                        <span className="detail-value highlight">
                                            ${parseFloat(producto.valor_total || 0).toFixed(2)}
                                        </span>
                                    </div>
                                ...
                                <div className="refaccion-card-actions">
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            // Abrir modal de detalles/movimientos
                                        }}
                                    >
                                        <Icon name="eye" />
